...
const features = [
  {
    number: "01",
    title: "SOV Matrix & Rankings",
    description: "Track Share of Voice for your brand and competitors across all platforms. Clear rankings, accurate comparisons.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Automated Weekly Crawl",
    description: "Automatic data crawl system every Sunday. No manual work needed — always have fresh data on your dashboard.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Track 3 Platforms",
    description: "Facebook, YouTube, TikTok — all in one dashboard. Compare competitor performance across every channel.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Professional Analytics Dashboard",
    description: "SOV Matrix, SOS Matrix, Rankings, Content Analysis, Benchmark, Trends — every metric you need in one interface.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        // Round to 6 decimal places to avoid SSR/client floating-point mismatch
        const cosV = Math.round(Math.cos(angle) * radius * 1e6) / 1e6;
        const sinV = Math.round(Math.sin(angle) * radius * 1e6) / 1e6;
        return (
          <g key={i}>
            {/* Connection line */}
            <line
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-12 lg:py-20 border-b border-foreground/10">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-48 h-40 text-[#1a358b]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">to outrank competitors.</span>
          </h2>
        </div>
